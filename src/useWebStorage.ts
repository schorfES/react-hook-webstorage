...
import { WebStorageUpdateEvent, buildEventName } from './events/WebStorageUpdateEvent';
...
function isCustomEvent<T>(event: unknown): event is CustomEvent<CustomEventDetail<T>> {
