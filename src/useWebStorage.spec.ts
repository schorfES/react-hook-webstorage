  ...
  describe('client side', () => {
    ...
    it('should handle updates across other useLocalStorage hooks', () => {
      ...
      act(() => {
        ...
        const event = new CustomEvent('react-hook-webstorage:mock-storage:update:foo', init);
      ...
      window.addEventListener('react-hook-webstorage:mock-storage:update:foo', onUpdateFoo);
      window.addEventListener('react-hook-webstorage:mock-storage:update:bar', onUpdateBar);
    ...
    it('should handle invalid updates attempts across other useLocalStorage hooks', () => {
      ...
      act(() => {
        // Wrong event type:
        const event = new MouseEvent('react-hook-webstorage:mock-storage:update:foo');
        window.dispatchEvent(event);
      });
      ...
      act(() => {
        ...
        const event = new CustomEvent('react-hook-webstorage:mock-storage:update:foo');
        window.dispatchEvent(event);
      });
